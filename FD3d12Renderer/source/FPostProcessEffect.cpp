...
void FPostProcessEffect::Init(int aPostEffectBufferIdx)
{
	...
	HRESULT hr;
	{
		...
		/*/
		myRootSignature = FD3d12Renderer::GetInstance()->GetRootSignature(nrOfSRVs, myNrOfCBV); // can't do this due ot the D3D12_DESCRIPTOR_RANGE_FLAG_DATA_STATIC_WHILE_SET_AT_EXECUTE flag
		//*/
